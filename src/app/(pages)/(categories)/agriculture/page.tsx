...
const AgriculturePage: FC = () => {
  const posts = [
    { slug: 'sustainable-farming', title: 'The Rise of Sustainable Farming Practices' },
    { slug: 'crop-innovation', title: 'Innovations in Crop Science' },
    // Add more posts here
  ];
